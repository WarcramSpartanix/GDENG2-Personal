...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        // Below we are displaying the font m_texture because it is the only m_texture we have access to inside the demo!
        ...
        // - The imgui_impl_opengl3.cpp renderer expect a GLuint OpenGL m_texture identifier, etc.
        // More:
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            ImVec2 uv1 = ImVec2(32.0f / my_tex_w, 32 / my_tex_h);   // UV coordinates for (32,32) in our m_texture
...
struct MyDocument
{
    ...
    bool        OpenPrev;   // Copy of Open from last drawUI.
